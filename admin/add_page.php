      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Add a Page</li>
          </ol>
          ...
          <form method="post" action="">
            ...
            <div class="form-group">
              <textarea name="content" id="content" cols="10" rows="10" class="tinymce"></textarea>
            </div>
            <div class="form-group">
              <label for="position">Position</label>
              <input type="number" class="form-control" id="position" min="2" max="50" name="position" placeholder="Position" required>
            </div>
